...
setGeneric("writeGFF3", signature="x", function(x, scoreType=c("absolute", "relative")) standardGeneric("writeGFF3"))
setGeneric("writeGFF2", signature="x", function(x, scoreType=c("absolute", "relative")) standardGeneric("writeGFF2"))
