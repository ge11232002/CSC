...
do_PairBSgenomeSearchPositive = function(pwm, BSgenome1, BSgenome2, chr1, chr2, 
  ...
  site2 = lapply(site2SeqsSet, function(seq1, pwm, strand, min.score){
               searchSeq(pwm, seq1, strand="+", min.score=min.score)
                         }, pwm, strand, min.score)
  ...
  site2RangesPositive = ranges(site2GRanges2)
  indexNegative = as.vector(strand(site2GRanges2) == "-")
  ...
  ans_site2 = SiteSet(
                      ...
                      seqname=chr2,
                      score=score(site2),
                      strand=as.vector(strand(site2GRanges2)),
