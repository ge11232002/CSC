...
function ts_makeSortable(t) {
	...
	for (var i=1; i < firstRow.cells.length-1;i++) {
		...
		if (cell.className != "unsortable" && cell.className.indexOf("unsortable") == -1) {
			cell.innerHTML = '<font face="Arial, Helvetica, sans-serif" size="2"><a href="#" class="sortheader" onclick="ts_resortTable(this, '+i+'); return false;">'+txt+'<span class="sortarrow">&nbsp;&nbsp;<img border=0 src="'+ image_path + image_none + '" alt="&darr;"/></span></a></font>';
		}
	}
