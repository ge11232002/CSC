...
cneMerge = function(cne1, cne2){
  ...
  cne1T = GRanges(seqnames=cne1$tName, 
                  ranges=IRanges(start=cne1$tStart, end=cne1$tEnd), strand="+")
  cne1Q = GRanges(seqnames=cne1$qName, 
                  ranges=IRanges(start=cne1$qStart, end=cne1$qEnd), strand="+")
  cne2T = GRanges(seqnames=cne2$tName, 
                  ranges=IRanges(start=cne2$tStart, end=cne2$tEnd), strand="+")
  cne2Q = GRanges(seqnames=cne2$qName, 
                  ranges=IRanges(start=cne2$qStart, end=cne2$qEnd), strand="+")
  cneT = c(cne1T, cne2T)
  cneQ = c(cne1Q, cne2Q)
