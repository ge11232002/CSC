...
void ceScan(char **targetSeq, char **querySeq, int *targetStart, int *targetEnd,
     int *queryStart, int *queryEnd, int *tFilterStart, int *tFilterEnd,
     int *qFilterStart, int *qFilterEnd, char **output)
{
