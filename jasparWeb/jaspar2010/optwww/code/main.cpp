...
int main (int argc, char *argv[])
{
	...
	bool neuralTree=false; bool testing=false;bool testingAcc=false; bool testingTree=false; bool famNames=false;
	bool ma_off=false;
...
void DisplayHelp()
{
	...
	printf("\t-ch\n\t\tRun Calinski & Harabasz tree cluster number statistic with the UPGMA tree.\n");
